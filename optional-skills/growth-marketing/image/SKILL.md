...
> **Hermes Growth note:** In Hermes Growth, product marketing context is stored in `config/growth.yaml`. The original paths above are still checked for compatibility.
