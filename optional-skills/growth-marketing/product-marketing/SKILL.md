...
> **Hermes Growth Note:** In the Hermes Growth framework, the product marketing context document is located at `config/growth.yaml`. The paths `.agents/product-marketing.md` and `.claude/product-marketing.md` are retained for backward compatibility with other marketing skill systems.
