...
> **Hermes Growth note:** In Hermes Growth, product marketing context is also available via `config/growth.yaml`. The original `.agents/product-marketing.md` and `.claude/product-marketing.md` references remain supported for compatibility.
