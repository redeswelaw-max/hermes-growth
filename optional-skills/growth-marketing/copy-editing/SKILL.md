...
> **Hermes Growth Note:** In Hermes Growth, the product marketing context is located at `config/growth.yaml`. The paths `.agents/product-marketing.md` and `.claude/product-marketing.md` are checked for backward compatibility.
